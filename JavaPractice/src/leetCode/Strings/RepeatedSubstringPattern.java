...
/**
 * Created by gouthamvidyapradhan on 25/03/2017. Given a non-empty string check
 * if it can be constructed by taking a substring of it and appending multiple
 * copies of the substring together. You may assume the given string consists of
